...
class StudentDetailsPage extends StatefulWidget {
  ...
  const StudentDetailsPage({Key? key, required this.selectedGrade, this.onTap});

  @override
  State<StudentDetailsPage> createState() => _StudentDetailsPage();
}

class _StudentDetailsPage extends State<StudentDetailsPage> {
