...
class TeacherPolicyPage extends StatefulWidget {
  final Function()? onTap;
  const TeacherPolicyPage({super.key, this.onTap});

  @override
  State<TeacherPolicyPage> createState() => _TeacherPolicyState();
}

class _TeacherPolicyState extends State<TeacherPolicyPage> {
  @override
